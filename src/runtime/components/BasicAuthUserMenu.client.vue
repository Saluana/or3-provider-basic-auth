      ...
      >
        ...
        <div class="p-2 space-y-1">
          ...
          <button
            ...
            @click="onSignOut"
          >
            <UIcon name="lucide:log-out" class="w-4 h-4 shrink-0" />
...
const DEFAULT_POPOVER_CONTENT: AuthUiPopoverContent = {
  side: 'right',
  align: 'end',
  sideOffset: 10,
  collisionPadding: 12,
...
const popoverContent = computed<AuthUiPopoverContent>(() => ({
  ...
  ...(injectedPopoverContent ? unref(injectedPopoverContent) : null),
}));
